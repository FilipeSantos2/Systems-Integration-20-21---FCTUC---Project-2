...
public class Researchers implements Serializable{
	...
	public Researchers(String name, int numberofpublications, int reads, int citations, String institutions_name, Set<SkillsAndExpertise> skills, Set<Publications> publications) {
		super();
		this.name = name;
